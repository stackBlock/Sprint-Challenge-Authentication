...
_session_ is how long you stay logged into a website after you are authenticated.

1. What does bcrypt do to help us store passwords in a secure manner.

bcrypt is a library that encrypts the password of users to your application by hashing it.

1. What does bcrypt do to slow down attackers?

bcrypt allows you to pick how many times you would like a users password hashed. the more time it is hashed, the longer it takes to login and the harder it is to break.
